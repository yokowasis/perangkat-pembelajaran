# MODUL AJAR KONSEP DASAR GRAF (SIMPUL, SISI, DERAJAT) - KELAS IX
...
<tbody>
    ...
    <tr>
        ...
        <td>Pada akhir fase D, peserta didik mampu memahami konsep dasar teori graf sebagai fondasi pemecahan masalah dalam jaringan dan algoritma</td>
    </tr>
    <tr>
        <td></td>
        ...
        <td>
            <ul>
                <li>Pemahaman konsep simpul (vertex) dan sisi (edge)</li>
                <li>Penguasaan konsep derajat simpul</li>
                <li>Visualisasi dan representasi graf sederhana</li>
            </ul>
        </td>
    </tr>
    <tr>
