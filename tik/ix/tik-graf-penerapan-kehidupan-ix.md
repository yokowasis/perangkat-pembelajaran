# MODUL AJAR PENERAPAN GRAF DALAM KEHIDUPAN SEHARI-HARI - KELAS IX
...
<tbody>
    ...
    <tr>
        ...
        <td>Pada akhir fase D, peserta didik mampu mengidentifikasi dan menganalisis penerapan konsep graf dalam berbagai aspek kehidupan dan teknologi modern</td>
    </tr>
    <tr>
        <td></td>
        ...
        <td>
            <ul>
                <li>Identifikasi aplikasi graf dalam teknologi</li>
                <li>Analisis struktur graf dalam sistem nyata</li>
                <li>Modeling masalah sehari-hari dengan graf</li>
            </ul>
        </td>
    </tr>
    <tr>
